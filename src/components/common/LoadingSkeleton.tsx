...
export function CardSkeleton({ size = 'small', className }: CardSkeletonProps) {
  if (size === 'featured') {
    return (
      <Card className={cn("col-span-1 sm:col-span-2 lg:col-span-3 row-span-2 p-0 bg-card rounded-3xl border border-border shadow-md flex flex-col justify-between overflow-hidden", className)}>
        {/* 2-Column Gallery Skeleton Header */}
        <div className="w-full h-52 sm:h-60 p-1.5 flex gap-1.5 bg-secondary/60 border-b border-border/60">
          <Skeleton className="w-[60%] h-full rounded-2xl bg-secondary border border-border/40" />
          <div className="w-[40%] h-full flex flex-col gap-1.5">
            <Skeleton className="h-1/2 rounded-xl bg-secondary border border-border/40" />
            <Skeleton className="h-1/2 rounded-xl bg-secondary border border-border/40" />
          </div>
        </div>
        ...
        <CardContent className="p-4 sm:p-5 space-y-3 flex-1 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
            <Skeleton className="h-7 rounded-lg bg-secondary/60" />
            <Skeleton className="h-7 rounded-lg bg-secondary/60" />
            <Skeleton className="h-7 rounded-lg bg-secondary/60" />
            <Skeleton className="h-7 rounded-lg bg-secondary/60" />
          </div>
          <div className="flex justify-end gap-2 pt-0.5">
            <Skeleton className="h-8 w-24 rounded-xl bg-secondary" />
  ...
  if (size === 'large') {
    return (
      <Card className={cn("col-span-1 sm:col-span-2 row-span-2 p-0 bg-card rounded-3xl border border-border shadow-md flex flex-col justify-between overflow-hidden", className)}>
        {/* 2-Column Gallery Skeleton Header */}
        <div className="w-full h-52 sm:h-60 p-1.5 flex gap-1.5 bg-secondary/60 border-b border-border/60">
          <Skeleton className="w-[60%] h-full rounded-2xl bg-secondary border border-border/40" />
          <div className="w-[40%] h-full flex flex-col gap-1.5">
        ...
        <CardContent className="p-4 sm:p-5 space-y-3 flex-1 flex flex-col justify-between">
          <div className="space-y-1.5">
            <Skeleton className="h-6 w-3/5 bg-secondary" />
  ...
  if (size === 'medium') {
    return (
      <Card className={cn("col-span-1 sm:col-span-2 row-span-1 p-3.5 bg-card rounded-3xl border border-border shadow-md flex gap-3.5 overflow-hidden", className)}>
        {/* Left 4:3 Image Skeleton */}
        <div className="w-[36%] sm:w-[34%] h-full min-h-[130px] rounded-2xl overflow-hidden bg-secondary/80 flex-shrink-0">
          <Skeleton className="w-full h-full rounded-2xl bg-secondary border border-border/40" />
        </div>
        ...
        <div className="flex-1 flex flex-col justify-between py-1">
          <div className="space-y-1.5">
            ...
            <Skeleton className="h-3.5 w-5/6 bg-secondary/60" />
          </div>
          ...
          <div className="flex justify-end gap-2">
            <Skeleton className="h-7 w-20 rounded-xl bg-secondary" />
  ...
  return (
    <Card className={cn("col-span-1 row-span-1 p-3 bg-card rounded-3xl border border-border shadow-md flex flex-col justify-between overflow-hidden", className)}>
      <div className="relative w-full h-28 rounded-2xl overflow-hidden bg-secondary/80 flex-shrink-0">
        <Skeleton className="w-full h-full rounded-2xl bg-secondary border border-border/40" />
      </div>
      ...
      <CardContent className="p-0 flex items-center justify-between mt-2 pt-1 border-t border-border/40">
        <Skeleton className="h-4 w-12 rounded-md bg-secondary" />
