    ...
    >
      <DrawerPrimitive.Portal>
        ...
        <DrawerPrimitive.Content
          ...
          className='fixed inset-x-0 bottom-0 z-50 flex flex-col bg-dark-bg/95 backdrop-blur-xl border-t border-dark-border/80 shadow-2xl max-w-2xl mx-auto rounded-t-[2rem] outline-none h-[92vh] transition-all'
        >
          {/* Top Pill Handle Bar */}
          <div className='flex items-center justify-center pt-3 pb-1.5 cursor-grab active:cursor-grabbing touch-none select-none flex-shrink-0'>
            <div className='w-10 h-1 rounded-full bg-dark-border/80 hover:bg-amber-gold/60 transition-colors' />
          </div>
