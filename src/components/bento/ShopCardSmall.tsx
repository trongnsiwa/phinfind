    ...
    >
      ...
      <div className="relative w-full h-28 rounded-2xl overflow-hidden bg-dark-bg flex-shrink-0 border border-dark-border/60">
        ...
        <Button
          ...
          className="absolute top-2.5 right-2.5 z-10 h-7 w-7 rounded-full bg-dark-bg/70 backdrop-blur-md hover:bg-dark-roast border border-dark-border/50 text-cream-white shadow-sm transition-all focus-visible:ring-1 focus-visible:ring-amber-gold focus-visible:ring-offset-0"
        >
          <Heart
            size={13}
            className={cn(
      ...
      <div className="space-y-1 mt-2 flex-1 flex flex-col justify-between">
        <div>
          <h4 className="font-sans font-bold text-xs sm:text-sm text-cream-white line-clamp-1 group-hover:text-amber-gold-hover transition-colors tracking-tight">
            {shop.name}
          </h4>
