  ...
  return (
    <div className="relative w-full group">
      ...
      <Input
        ...
        className="w-full h-11 pl-10 pr-10 text-xs sm:text-sm bg-input-bg text-foreground border-input rounded-2xl focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-gold/60 focus-visible:ring-offset-0 focus-visible:border-amber-gold/60 focus-visible:shadow-[0_0_0_1px_rgba(184,134,11,0.25)] focus-visible:scale-[1.005] hover:border-amber-gold/40 shadow-xs transition-all duration-200 ease-out placeholder:text-muted-foreground"
      />
      {localValue && (
        <Button
          variant="ghost"
          size="icon"
          onClick={handleClear}
          className="absolute right-2 top-1/2 -translate-y-1/2 h-7 w-7 text-muted-foreground hover:text-foreground hover:bg-muted rounded-full transition-colors focus-visible:ring-1 focus-visible:ring-amber-gold focus-visible:ring-offset-0"
