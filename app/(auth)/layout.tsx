import { Coffee, MapPin, ShieldCheck, Sparkles, Star, Users } from 'lucide-react';
...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className='min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-background via-muted/40 to-background text-foreground relative overflow-hidden'>
        ...
        <div className='w-full grid grid-cols-1 md:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl shadow-black/10 dark:shadow-black/60 border border-border bg-card gap-0'>
          ...
          <div className='md:hidden p-5 bg-gradient-to-b from-muted/50 to-card border-b border-border text-foreground flex items-center justify-between'>
            <Link href='/' className='inline-flex items-center gap-3'>
              ...
              <div>
                <h1 className='font-sans font-bold text-lg leading-none text-foreground'>
                  PhinFind
                </h1>
          ...
          <div className='hidden md:flex flex-col justify-between p-8 lg:p-10 bg-gradient-to-b from-muted/60 to-card text-foreground relative overflow-hidden border-r border-border'>
            ...
            <svg
              className='absolute -right-12 -bottom-12 w-64 h-64 text-amber-gold/5 pointer-events-none select-none'
              viewBox='0 0 200 200'
              fill='currentColor'
              aria-hidden='true'
            >
              ...
              />
              <path
                d='M100 30 C 95 60, 80 80, 80 110 A 20 20 0 0 0 120 110 C 120 80, 105 60, 100 30 Z'
                fill='currentColor'
                opacity='0.5'
              />
            </svg>
            ...
            <div className='relative z-10 space-y-6'>
              <Link href='/' className='inline-flex items-center gap-3.5 group'>
                ...
                <div>
                  <h1 className='font-sans font-bold text-2xl lg:text-3xl leading-none text-foreground tracking-tight group-hover:text-amber-gold transition-colors'>
                    PhinFind
                  </h1>
              ...
              <div className='pt-4 space-y-3'>
                ...
                <h2 className='font-sans font-bold text-2xl lg:text-3xl leading-tight tracking-tight text-foreground'>
                  Khám phá những quán cà phê tuyệt vời nhất ở mọi nơi bạn đến.
                </h2>
                <p className='text-sm text-muted-foreground leading-relaxed font-body'>
                  Lưu lại các quán yêu thích, khám phá bản đồ tương tác và nhận chỉ đường nhanh
                  chóng đến những quán cà phê độc đáo.
                </p>
              </div>

              {/* Floating Coffee Cup Illustration with Animated Steam */}
              <div className='p-2 flex items-center gap-4'>
                <div className='relative w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-gold/15 to-amber-gold/5 border border-amber-gold/30 flex items-center justify-center shadow-md backdrop-blur-md shrink-0'>
                  {/* Rising Steam Wisps */}
          ...
          <div className='bg-card backdrop-blur-md p-6 sm:p-8 lg:p-10 flex flex-col justify-center relative text-foreground'>
            {children}
          </div>
        </div>
      </div>
