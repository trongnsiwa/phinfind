...
export function ShopDetailClient({ shop: initialShop }: ShopDetailClientProps) {
  ...
  const shopId = initialShop.place_id || initialShop.id;
  const {
    data: queryShop,
    isFetching,
    error,
  ...
  // Prefer queryShop if updated, but initial render is immediate via initialShop
